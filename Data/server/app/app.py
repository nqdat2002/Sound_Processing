...
RESULT = 'result.html'
ERROR = 'error.html'
model = os.path.join(THIS_DIR, 'model', 'AM_efficientnet_5classes_callbackb4.h5')
# classes = np.array(['Acroc', 'Ember', 'Parus', 'Phyll', 'Sylvi'])
classes = np.array(['0Acroc', '1Ember', '2Parus', '3Phyll', '4Sylvi'])
...
def prediction():
    ...
    if file and allowed_file(file.filename):
        ...
        if result['probability'] > 75:
            ...
            print(bird_type, name, en_name, desc)
